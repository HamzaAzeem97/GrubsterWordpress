...
class Generator 
{
	...
	{
		$this_category = get_category($this->get_current_id());
	...
	{
		$queried_object = $this->get_current_id();
	...
	/**
	 * Return current global post id (single, page etc.)
	 *
	 * @return int
	 */
